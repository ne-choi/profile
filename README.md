...
디지털 광고 업계에서 일하면서, 고객 데이터 수치를 깊이있게 파악하고 싶어 데이터 공부를 시작했습니다. 결국 퇴사를 선택했고 20년 8월부터 데이터 분석 공부를 하고 있습니다. Python과 R을 사용하며, SQL도 꾸준히 공부하고 있습니다. 데이터를 통해 인사이트를 얻는 일에 흥미가 있습니다.
...
- **자격증**
  - SQLD SQL 개발자 / 2021.12.17 / 한국데이터산업진흥원
